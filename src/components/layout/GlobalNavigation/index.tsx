...
export const GlobalNavigation = ({ name, email, myPageUrl, avatarUrl, onLogout }: GlobalNavigationProps) => {
  return (
    <nav className="fixed right-0 bottom-0 left-0 z-50 border-t border-gray-200 bg-white backdrop-blur-sm md:static md:h-screen md:w-16 md:border-t-0 md:border-r md:px-2 md:py-6 xl:w-64 xl:px-4">
